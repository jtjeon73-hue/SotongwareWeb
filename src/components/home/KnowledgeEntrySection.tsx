...
export function KnowledgeEntrySection() {
  ...
  const siteUrl = knowledge ? getExternalSiteUrl(knowledge) : undefined;
      ...
      <div className="container-main">
        <div className="rounded-2xl border border-brand-200 bg-gradient-to-br from-brand-50/80 to-white p-6 sm:p-8">
          <SectionHeader
            ...
            description="무료 정보부터 회원·유료·구독까지 — SotongWare 지식·교육 채널과 지식·교육 사이트에서 탐색할 수 있습니다."
            className="!mb-0"
          />
          <div className="mt-6 flex flex-col gap-3 sm:flex-row sm:flex-wrap">
            ...
            {siteUrl && (
              <Button href={siteUrl} variant="outline" external className="min-h-11">
                지식·교육 사이트 ↗
              </Button>
            )}
            <Link
